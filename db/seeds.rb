...
wtbtask01 = Task.create!(title: 'Click into the + create input fields to write Team and Project names, as well as Task descriptions.', details: '', project_id: wtbproj01.id, team_id: wtbproj01.team_id, index: 0)
...
task01 = Task.create!(title: 'Primary Task',   details: '', project_id: proj01.id, team_id: proj01.team_id, index: 0)
task02 = Task.create!(title: 'Secondary Task', details: '', project_id: proj01.id, team_id: proj01.team_id, index: 1)
task03 = Task.create!(title: 'Tertiary Task',  details: '', project_id: proj01.id, team_id: proj01.team_id, index: 2)

task04 = Task.create!(title: 'Quaternary Task', details: '', project_id: proj05.id, team_id: proj05.team_id, index: 0)
task05 = Task.create!(title: 'Quinary Task',    details: '', project_id: proj05.id, team_id: proj05.team_id, index: 1)
task06 = Task.create!(title: 'Senary Task',     details: '', project_id: proj05.id, team_id: proj05.team_id, index: 2)
task07 = Task.create!(title: 'Septenary Task',  details: '', project_id: proj05.id, team_id: proj05.team_id, index: 3)
task08 = Task.create!(title: 'Octonary Task',   details: '', project_id: proj05.id, team_id: proj05.team_id, index: 4)

task09 = Task.create!(title: 'Primary Task', details: '', project_id: proj02.id, team_id: proj02.team_id, index: 0)

task10 = Task.create!(title: 'Secondary Task', details: '', project_id: proj03.id, team_id: proj03.team_id, index: 0)
task11 = Task.create!(title: 'Tertiary Task',  details: '', project_id: proj03.id, team_id: proj03.team_id, index: 1)

task12 = Task.create!(title: 'Quaternary Task', details: '', project_id: proj04.id, team_id: proj04.team_id, index: 0)
task13 = Task.create!(title: 'Quinary Task',    details: '', project_id: proj04.id, team_id: proj04.team_id, index: 1)

task14 = Task.create!(title: 'Senary Task',    details: '', project_id: proj06.id, team_id: proj06.team_id, index: 0)
task15 = Task.create!(title: 'Septenary Task', details: '', project_id: proj06.id, team_id: proj06.team_id, index: 1)
task16 = Task.create!(title: 'Octonary Task',  details: '', project_id: proj07.id, team_id: proj07.team_id, index: 1)
